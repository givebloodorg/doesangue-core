...
*/
 class Doador extends User{
 	...
 	public function novoDoador(){
 		...
 		$executa = array($this->nome, $this->sobrenome, $this->gp_sangue, $this->user_id, $this->nascimento);
 	...
 	public function editDoador(){
 		...
 		$executa = array($this->nome, $this->sobrenome, $this->gp_sangue, $this->nascimento);
 		return $preparar->execute($executa);
 	}
